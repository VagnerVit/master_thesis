...
| **Pokročilý** | Aktivně plavající dospělý — od rekreačních po závodní plavce | 15+, libovolná rychlost | Sloučení dřívějších kategorií „Plavec" + „Kompetitivní". Prahy odpovídají širšímu rozsahu (tolerance ±15°). |
...
> **Poznámka k detailním tabulkám:** V sekcích 2–7 tohoto dokumentu jsou u některých metrik stále uvedeny tři řádky (Dítě / Plavec / Kompetitivní) z původní rešerše — slouží jako referenční data z literatury. **Implementace systému používá 2 kategorie** (Dítě + Pokročilý). Souhrnné tabulky v sekci 8 reflektují aktuální 2 kategorie.
...
> **Poznámka ke sloučení:** Pokročilý používá širší rozsah z dřívější kategorie „Plavec" (optimální rozsah) s tolerancí ±15°. Přísnější prahy dřívější kategorie „Kompetitivní" (±8°) jsou dostupné v detailních tabulkách sekcí 2–7 pro případné budoucí rozšíření na kategorii Profesionál.
...
| Minor | Elbow < 12,5°; ostatní < 15° | Odchylka < 7,5° |
...
- [ ] Cappaert et al. (1995) — conference proceedings (kniha, nedostupné online)
...
- [ ] Vorontsov (2002) — kniha, nedostupné online
...
- [x] Souhrnné tabulky (sekce 8) reflektují 2 kategorie (Dítě + Pokročilý)
- [x] Detailní tabulky (sekce 2–7) zachovávají 3-úrovňová data z literatury pro referenci
...
- [x] Kategorie „Pokročilý" = sloučení „Plavec" + „Kompetitivní" s širšími rozsahy a tolerancí ±15°
- [x] Přísnější prahy (±8°) zachovány v detailních tabulkách pro budoucí kategorii Profesionál
