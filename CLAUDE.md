...
- **Analýza**: DTW + pravidlový systém + RAG-rozšířený LLM feedback
- **3 úrovně plavců**: začátečník / mírně pokročilý / expert
...
C. BIOMECHANICKÁ ANALÝZA (4-5 týdnů)
   ...
   C2. Vytvoření referenčních vzorů (min 1 styl × 1 pohled × 3 úrovně)
...
### Upload flow
1. Video + výběr úrovně (začátečník/mírně pokročilý/expert) + pohled (side/front/underwater) + styl
